...
int FinanceService::addExpense(std::string const& date, std::string const& category, double amount,
...
int FinanceService::addIncome(std::string const& date, std::string const& source, double amount,
                              std::string const& description) const
{
    validateDate(date);
...
int FinanceService::addBudget(std::string const& category, double amount,
                              std::string const& period) const
{
    validateText(category, "Category");
...
std::vector<Expense> FinanceService::filterExpenses(std::string const& category,
