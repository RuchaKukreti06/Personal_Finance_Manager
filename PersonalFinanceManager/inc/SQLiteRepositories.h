...
namespace finance
{
// SQLite implementation of expense repository interface
...
public:
    ...
    std::vector<Expense> filter(const std::string& category,
...
// SQLite implementation of income repository interface
...
// SQLite implementation of budget repository interface
...
// SQLite implementation of user repository interface
