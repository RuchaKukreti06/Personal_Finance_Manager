...
class FinanceService
{
   public:
    ...
    int addExpense(const std::string& date, const std::string& category, double amount,
                   const std::string& description) const;
    std::vector<Expense> listExpenses() const;
    std::vector<Expense> filterExpenses(const std::string& category, const std::string& startDate,
                                        const std::string& endDate) const;
    bool deleteExpense(int expenseId) const;
    int addIncome(const std::string& date, const std::string& source, double amount,
                  const std::string& description) const;
    std::vector<Income> listIncome() const;
    int addBudget(const std::string& category, double amount, const std::string& period) const;
